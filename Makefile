.PHONY: clean clean-build clean-pyc compile_translations coverage diff_cover docs dummy_translations \
        ...
        docker-build docker-run static check-dependencies
...
docs: ## generate Sphinx HTML documentation, including API docs
	$(TOX) -e docs
    $(BROWSER)$(BUILD_DIR)/html/index.html
...
static: ## validate and collect static files
